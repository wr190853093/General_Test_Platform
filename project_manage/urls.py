...
urlpatterns = [
    ...
    # 项目管理模块接口
    path(r'creatproject/', creat_project),  # 新建项目
    ...
    # 接口管理
    path(r'creatapi/', creat_api),  # 新增接口
